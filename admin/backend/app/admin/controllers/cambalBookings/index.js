...
import CambalBookingsController from './cambal-bookings.controller';
import { controllerHandler } from '../../../utils/async.handler';
import Validator from './cambal-bookings.validation';

const router = express.Router();
const controller = new CambalBookingsController();
