...
// Certificate
/*const privateKey = fs.readFileSync('/etc/letsencrypt/live/n2rtechnology.online/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/n2rtechnology.online/cert.pem', 'utf8');
const ca = fs.readFileSync('/etc/letsencrypt/live/n2rtechnology.online/chain.pem', 'utf8');
...
/* app.use('/customers', express.static(path.resolve(__dirname, '../admin/dist')));
 app.use('/booking-prices', express.static(path.resolve(__dirname, '../admin/dist')));
 app.use('/events', express.static(path.resolve(__dirname, '../admin/dist')));
 app.use('/dashboard', express.static(path.resolve(__dirname, '../admin/dist')));
 app.use('/settings', express.static(path.resolve(__dirname, '../admin/dist')));*/
 
app.use('/terms-and-condition', express.static(path.resolve(__dirname, '../dist')));
...
app.use('/about-us', express.static(path.resolve(__dirname, '../dist')));
app.use('/contact-us', express.static(path.resolve(__dirname, '../dist')));
app.use('/terms-and-condition', express.static(path.resolve(__dirname, '../dist')));
app.use('/privacy-policy', express.static(path.resolve(__dirname, '../dist')));
app.use('/admin', express.static(path.resolve(__dirname, '../admin/dist')));
app.use('/blog', express.static(path.resolve(__dirname, '../blog')));
app.use('/admin/uploads/', express.static(path.resolve(__dirname, '../admin/uploads')));
// app.use('/admin/main/customers', express.static(path.resolve(__dirname, '../admin/backend/dist/app/routes.js')));
